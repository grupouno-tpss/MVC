<body>
    ...
    <!-- Modal -->
    <div class="modal fade" id="menuAdmint" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            foreach ($value as $menu) {
                echo '
                    ...
                    <div class="card-body">
                      ...
                      <button class="btn btn-primary" id="' . $menu['id_menu'] . '">Añadir al carrito</button>
